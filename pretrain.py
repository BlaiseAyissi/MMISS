...
from data.rsna_dataset import rsna_dataset  #change this datasets with the MPC-AO dataset
from data.medicat_dataset import Medicat_dataset
from data.pcm_oa_datasets import Pcm_oa_dataset
...
def main(args, config):
    ...
    #changing the datesets from medicat to PMC_OA
    #datasets = Medicat_dataset(data_dir,cap_path, list_dir, transform=transform_train)
    datasets = Pcm_oa_dataset(new_data_dir,new_cap_path, transform=transform_train)
